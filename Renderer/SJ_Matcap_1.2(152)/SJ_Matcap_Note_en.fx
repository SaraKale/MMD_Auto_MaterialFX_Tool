...
//----------------------------------------
// albedo matcap multiplied by Sph texture color
//----------------------------------------
// Enable Matcap mapping
// 0: Invalid
// 1: Enable the Matcap function, and at this time, the calculation method is multiplication.
// 2: Enable the Matcap function, and at this time, the calculation method is additive.
#define ALBEDO_MATCAP_ENABLE 0

// [When ALBEDO_MATCAP_ENABLE is 1 or 2] Fill in the path name of the Matcap image here.
#define ALBEDO_MATCAP_MAP_FILE "matcap.png"

// Matcap influence source
// 0: Disable reading the channel image of the influence degree.
// 1: Enable the channel image that reads the impact level.
#define ALBEDO_MATCAP_MAP_AFFECT_FROM 0

// Channels affecting texture
// 0: Read the R channel of the channel image that represents the influence degree.
// 1: Read the G channel of the channel image representing the degree of impact.
// 2: Read the B channel of the channel image representing the degree of impact.
// 3: Read the Alpha channel of the channel image representing the influence degree.
// When it is 4 or undefined: Read the RGB channels of the channel image representing the influence level.
#define ALBEDO_MATCAP_MAP_AFFECT_SWIZZLE 4  

// [When ALBEDO_MATCAP_MAP_AFFECT_FROM is set to 1] Fill in the path name of the channel image that determines the degree of influence here.
#define ALBEDO_MATCAP_MAP_AFFECT_FILE "affect.png"

// Matcap color intensity, can use float3 to control RGB.
const float3 albedoMatcap = 1.0; (Note: This line is actually code and remains the same in English as it uses universal programming syntax. If a verbal translation is strictly needed for non-code context, it would be: "Constant floating-point 3D vector albedoMatcap is assigned a value of 1.0.")
// This field indicates the extent to which the material is affected.
// When this value is closer to 0, it indicates less influence from Matcap (regardless of multiplication or addition operations).
// When this value is 1, it indicates full influence from Matcap (regardless of multiplication or addition operations).
// Note that float3 can be used to control RGB.
// If ALBEDO_MATCAP_MAP_AFFECT_FROM is set to 1, this value will be multiplied by the channel image indicating the degree of influence.
...
// Texture path
#define METALNESS_MAP_FILE "metal.png"
